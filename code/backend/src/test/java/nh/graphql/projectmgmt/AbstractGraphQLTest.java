...
public abstract class AbstractGraphQLTest {
  ...
  private static User newUser(String id, String login, String name) {
    User user = new User();
    user.setId(id);
    user.setLogin(login);
    user.setName(name);
  ...
  public void configureUserServiceMock() {
    ...
    allUsers.add(newUser("U1", "nils", "Nils Hartmann"));
    allUsers.add(newUser("U2", "susi", "Susi Mueller"));
    allUsers.add(newUser("U3", "klaus", "Klaus Schneider"));
    allUsers.add(newUser("U4", "sue", "Sue Taylor"));
    allUsers.add(newUser("U5", "lauren", "Lauren Jones"));
    allUsers.add(newUser("U6", "olivia", "Olivia Smith"));
    allUsers.add(newUser("U7", "cathy", "Cath Brown"));
    allUsers.add(newUser("U8", "maja", "Maja Walsh"));
